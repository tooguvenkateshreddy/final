			...
			<div class="col-sm-1 col-md-4 col-lg-2 d2">
				<div class="container d1">
					...
					<div style="margin: 6px;" align="center">
						...
						<h4>M/S <%=session.getAttribute("user")%></h4>
						<h6>3.7</h6>
						<dl>
							<dt>
								<h5>Contact</h5>
			...
			<div class="col-sm-11 col-md-8 col-lg-10">
				<div class="container">
					<div class="btn-group b1" style="width: 105%">
						...
						<a href="inventory.jsp" class="btn btn-lg btn-outline-secondary">INVENTORY</a>
					...
					<div class="container">
						<table class="table t1 ">
							...
							<tr  class="tr1">
								<td><input type="checkbox" class="r1 mr-sm-2" />Add Name</td>
								<td>Enter ID</td>
								<td></td>
								<td></td>
								<td>0.0</td>
								<td><input class="form-rounded br1" type="button"
									value="View"> <input class="form-rounded br1"
									type="button" value="Remove"></td>
							</tr>
							<c:forEach var="row" items="${result.rows}">
								<tr>
									<td><input type="checkbox" class="r1 mr-sm-2" />
									...
									<td><a
										href="view.jsp?desc=${row.description}&price=${row.price}&brand=${row.brand}&name=${row.name}&rating=${row.rating}"><input
											class="form-rounded br1" type="button" value="View"></a><input
										class="form-rounded br1" type="button" value="Remove"></td>
								</tr>
							</c:forEach>
